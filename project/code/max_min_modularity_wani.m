function q = max_min_modularity_wani(A,Ap,z,varargin)

% function q = max_min_modularity_wani(A,z, [optional 'scalar' or 'degree'])
%
...
if docateg
    ...
    for i = 1:numel(u)
        ...
        q = q - sum(sum(Ap(z==u(i),z==u(i))))./mp2 - (sum(sum(Ap(z==u(i),:)))./mp2)^2;
    end
